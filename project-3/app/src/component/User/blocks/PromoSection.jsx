...
// const PromoSection = () => {
//   return (
//     <section className="bg-white px-4 pb-8 antialiased dark:bg-gray-900">
//       <div className="mx-auto grid max-w-screen-xl rounded-lg bg-white p-4 dark:bg-gray-800 md:p-8 lg:grid-cols-12 lg:gap-8 lg:p-16 xl:gap-16">
