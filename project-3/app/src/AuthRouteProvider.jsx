...
import Error from './component/AssetCopm/Error';
    ...
    <Routes>
      ...
      {user && user.role === 'user' && (
        <>
          ...
          <Route path="/update-user/:id" element={<ProtectedRoute role="user"><UpdateUser /></ProtectedRoute>} />
          <Route path="/profile" element={<ProtectedRoute role="user"><Profile /></ProtectedRoute>} />
          <Route path="/book-details/:id" element={<ProtectedRoute role="user"><ProductOverview /></ProtectedRoute>} />
        </>
      )}
